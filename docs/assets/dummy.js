...
define('dummy/components/data-power-select', ['exports', 'ember-data-power-select/components/data-power-select'], function (exports, _dataPowerSelect) {
  'use strict';
  ...
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function () {
      return _dataPowerSelect.default;
    }
  });
});
...
define('dummy/ember-data-power-select/tests/addon.lint-test', [], function () {
  'use strict';

  QUnit.module('ESLint | addon');

  QUnit.test('ember-data-power-select/components/data-power-select.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ember-data-power-select/components/data-power-select.js should pass ESLint\n\n');
  });
});
define('dummy/ember-data-power-select/tests/app.lint-test', [], function () {
  'use strict';
...
define('dummy/serializers/user', ['exports', 'ember-data'], function (exports, _emberData) {
  'use strict';
  ...
  exports.default = _emberData.default.RESTSerializer.extend({
    normalizeArrayResponse: function normalizeArrayResponse(_0, _1, payload) {
      payload.users = payload.results;
      payload.users.forEach(function (u) {
        return u.id = Ember.guidFor(u.id);
      });
...
define("dummy/templates/application", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "SK1sWHb0", "block": "{\"symbols\":[\"user\"],\"statements\":[[6,\"h2\"],[9,\"id\",\"title\"],[7],[0,\"Ember Data Power Select\"],[8],[0,\"\\n\"],[6,\"p\"],[7],[0,\"Extends \"],[6,\"a\"],[9,\"href\",\"https://ember-power-select.com/\"],[9,\"target\",\"_blank\"],[7],[0,\"ember-power-select\"],[8],[8],[0,\"\\n\"],[6,\"p\"],[7],[0,\"Integrate into Ember-Data. The search function will do a \\\"store.query(modelName, queryArgs)\\\" by default\"],[8],[0,\"\\n\\n\"],[6,\"pre\"],[9,\"style\",\"background: #f9f9f9\"],[7],[0,\"\\n  {{#data-power-select\\n    modelName='user'\\n    queryArgs=(hash limit=10)\\n    as |user|\\n  }}\\n    {{user.name}}\\n  {{/data-power-select}}\\n  \"],[6,\"br\"],[7],[8],[0,\"\\n\"],[8],[0,\"\\n\"],[4,\"data-power-select\",null,[[\"allowClear\",\"modelName\",\"onchange\",\"queryArgs\",\"selected\",\"placeholder\"],[true,\"user\",[25,\"action\",[[19,0,[]],[25,\"mut\",[[20,[\"selected\"]]],null]],null],[25,\"hash\",null,[[\"results\"],[10]]],[20,[\"selected\"]],\"Search Users...\"]],{\"statements\":[[0,\"  \"],[6,\"img\"],[10,\"src\",[26,[[19,1,[\"picture\",\"thumbnail\"]]]]],[7],[8],[0,\"\\n  \"],[6,\"div\"],[9,\"style\",\"display: inline-block\"],[7],[0,\"\\n    \"],[6,\"span\"],[7],[1,[19,1,[\"fullName\"]],false],[8],[6,\"br\"],[7],[8],[0,\"\\n    \"],[6,\"span\"],[7],[1,[19,1,[\"email\"]],false],[8],[0,\"\\n  \"],[8],[0,\"\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "dummy/templates/application.hbs" } });
});
