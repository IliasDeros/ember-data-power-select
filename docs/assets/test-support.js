...
define('ember-power-select/test-support/helpers', ['exports', 'ember-test-helpers/wait', 'ember-native-dom-helpers'], function (exports, _wait, _emberNativeDomHelpers) {
  ...
  exports.default = function () {
    Ember.Test.registerAsyncHelper('selectChoose', function (_, cssPathOrTrigger, valueOrSelector, optionIndex) {
      (true && !(true) && Ember.deprecate('Using the implicit global async helper `selectChoose` is deprecated. Please, import it explicitly with `import { selectChoose } from "ember-power-select/test-support/helpers"`', true, { id: 'ember-power-select-global-select-choose', until: '2.0.0' }));
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                (true && !(true) && Ember.deprecate('Using the implicit global async helper `selectSearch` is deprecated. Please, import it explicitly with `import { selectSearch } from "ember-power-select/test-support/helpers"`', true, { id: 'ember-power-select-global-select-search', until: '2.0.0' }));
                return _context5.abrupt('return', selectSearch(cssPathOrTrigger, value));
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                (true && !(true) && Ember.deprecate('Using the implicit global async helper `removeMultipleOption` is deprecated. Please, import it explicitly with `import { removeMultipleOption } from "ember-power-select/test-support/helpers"`', true, { id: 'ember-power-select-global-remove-multiple-option', until: '2.0.0' }));
                return _context6.abrupt('return', removeMultipleOption(cssPath, value));
        ...
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                (true && !(true) && Ember.deprecate('Using the implicit global async helper `clearSelected` is deprecated. Please, import it explicitly with `import { clearSelected } from "ember-power-select/test-support/helpers"`', true, { id: 'ember-power-select-global-clear-selected', until: '2.0.0' }));
                return _context7.abrupt('return', clearSelected(cssPath));
